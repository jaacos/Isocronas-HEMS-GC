/* ============================================================
   SUC HEMS AH-30 · Isócronas Gran Canaria · Service Worker
   Clonado de la versión de Tenerife. Rutas relativas
   (compatible con GitHub Pages). Sin dependencias externas:
   todo lo necesario se cachea aquí.
   Para forzar una actualización en todos los dispositivos,
   sube los cambios y aumenta el número de versión de abajo.
   ============================================================ */
const CACHE_VERSION = "suc-hems-gc-v10";
